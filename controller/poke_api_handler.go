...
var (
	...
	ErrorPokeApiFailure  = errors.New("unexpected response in Pokeapi")
)
...
func GetPokemon(w http.ResponseWriter, r *http.Request) {
	...
	if errors.Is(err, ErrorPokemonNotFound) {
...
func GetPokemonFromPokeApi(id string) (models.PokeApiPokemonResponse, error) {
	...
	if response.StatusCode == http.StatusNotFound {
		return models.PokeApiPokemonResponse{}, ErrorPokemonNotFound
	}

	if response.StatusCode != http.StatusOK {
		return models.PokeApiPokemonResponse{}, ErrorPokeApiFailure
	}
